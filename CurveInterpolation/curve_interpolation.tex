...
\begin{document}
    \begin{center}
        ...
        \vspace{0.25cm}
        {\large Joe Mallonee \& David G. Turner}
    \end{center}
    ...
    Prove that the second derivative at $b_0$ of a Bézier cubic specified by the control
    points $(b_0, b_1, b_2, b_3)$ is
    \[
        6(b_0-2b_1+b_2)
    \]
    ...
    \end{align*}
    Note that $d_0$ is on the line segment $\left(x_0, d_1\right)$ (1/3 of the way from $x_0$)
    and $d_N$ is on the line segment $\left(d_{N-1}, x_N\right)$ (1/3 of the way from $x_N$).
    For this proof, you may use Equation $(1)$.

    In the above derivation we assume that $N\geq 4$. If $N = 3$, show that this system reduces
    to
    \[
        \begin{pmatrix}
            4 & 1 \\
