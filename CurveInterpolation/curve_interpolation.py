...
def create_constants_matrix(points: np.ndarray) -> np.ndarray:
...
def solve_for_d_matrix(points: np.ndarray) -> np.ndarray:
    ...
    coefficients_matrix: np.ndarray = create_coefficients_matrix(n)
    constants_matrix: np.ndarray = create_constants_matrix(points)
